...
class CupertinoTypeAheadField<T> extends StatefulWidget {
  ...
  @override
  CupertinoTypeAheadFieldState<T> createState() => CupertinoTypeAheadFieldState<T>();
  // State<WorkingCenterScreen> createState() => WorkingCenterScreenState();
}

class CupertinoTypeAheadFieldState<T> extends State<CupertinoTypeAheadField<T>> with WidgetsBindingObserver {
