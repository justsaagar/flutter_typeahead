...
class CupertinoSuggestionsList<T> extends StatefulWidget {
  ...
  @override
  CupertinoSuggestionsListState<T> createState() => CupertinoSuggestionsListState<T>();
}

class CupertinoSuggestionsListState<T> extends State<CupertinoSuggestionsList<T>> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    bool isEmpty = (_suggestions?.isEmpty ?? true) && widget.controller!.text == "";
  ...
  Widget defaultSuggestionsWidget() {
      ...
      child: ListView.separated(
        ...
        itemBuilder: (BuildContext context, int index) {
          return GestureDetector(
            ...
            child: widget.itemBuilder!(context, this._suggestions!.elementAt(index)),
            onTap: () {
    ...
    if (widget.decoration!.hasScrollbar) {
      child = MediaQuery.removePadding(context: context, removeTop: true, child: CupertinoScrollbar(child: child));
    }
