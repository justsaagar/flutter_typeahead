          ...
          child: ListView(
            ...
            children: [
              TypeAheadFormField<String>(
                textFieldConfiguration: TextFieldConfiguration(autofocus: true, inputFormatters: [LengthLimitingTextInputFormatter(50)], controller: _controller, decoration: const InputDecoration(labelText: 'Type Ahead')),
...
class CupertinoTestPage extends StatefulWidget {
  ...
  const CupertinoTestPage({super.key, this.minCharsForSuggestions = 0});
